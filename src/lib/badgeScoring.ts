/**
 * Sage Badge scoring (Charter v1.0). Shared by admin UI previews and Edge publish logic.
 * Keep in sync with supabase/functions/_shared/badge-scoring.ts
 */
...
/** Charter §7: Ready 12 mo; Trusted/Exceptional 24 mo; others 12 mo default. */
export function computeNextReviewDue(level: BadgeLevel, assessedAt: Date = new Date()): Date {
  const months =
    level === "trusted" || level === "exceptional" ? 24 : 12;
